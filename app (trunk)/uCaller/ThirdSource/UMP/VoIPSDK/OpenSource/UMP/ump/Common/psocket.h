...
#ifndef __UMPStack__psocket__
#define __UMPStack__psocket__
...
public:
    PBOOL Read(void * ptr, PINDEX len);
    ~PSocket();
};
...
public:
    ...
    PBOOL IsPresent(SOCKET fd) const
    {
...
#endif /* defined(__UMPStack__psocket__) */
