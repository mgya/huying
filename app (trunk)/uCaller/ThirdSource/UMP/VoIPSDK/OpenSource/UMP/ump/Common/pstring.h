...
#ifndef __UMPStack__pstring__
#define __UMPStack__pstring__
...
public:
    ...
    void Replace(
                 ...
                 PBOOL all = FALSE,         ///< Replace all occurrences of target text.
                 PINDEX offset = 0         ///< Offset into string to begin search.
    );
...
public:
    ...
    PStringArray(
                 ...
                 PBOOL caseless = FALSE         ///< New strings are to be PCaselessStrings
    );
...
public: \
    ...
    virtual PBOOL SetDataAt(PINDEX index, const PString & str) \
    { return PAbstractDictionary::SetDataAt(index,PNEW PString(str));} \
    virtual PBOOL SetAt(const K & key, const PString & str) \
    { return AbstractSetAt(key, PNEW PString(str)); } \
...
public:
    ...
    PStringToOrdinal(
                     PINDEX count,                ///< Count of strings in initialiser array
                     const Initialiser * init,    ///< Array of Initialiser structures
                     PBOOL caseless = FALSE        ///< New keys are to be PCaselessStrings
    );
    //@}
...
public:
    ...
    PStringToString(
                    PINDEX count,                ///< Count of strings in initialiser array
                    const Initialiser * init,    ///< Array of Initialiser structures
                    PBOOL caselessKeys = FALSE,   ///< New keys are to be PCaselessStrings
                    PBOOL caselessValues = FALSE  ///< New values are to be PCaselessStrings
    );
    //@}
...
#endif /* defined(__UMPStack__pstring__) */
