...
#ifndef __UMPStack__pcontainer__
#define __UMPStack__pcontainer__
...
protected:
    ...
    public:
        ...
        int count;
        PBOOL deleteObjects;    // Used by PCollection but put here for efficiency
#if PCONTAINER_USES_CRITSEC
...
public:
    ...
    PINLINE void AllowDeleteObjects(
                                    PBOOL yes = TRUE   ///< New value for flag for deleting objects
    );
...
#endif /* defined(__UMPStack__pcontainer__) */
