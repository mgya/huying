...
#ifndef __UMPStack__plist__
#define __UMPStack__plist__
...
protected:
    ...
    void DeleteSubTrees(Element * node, PBOOL deleteObject);
...
#endif /* defined(__UMPStack__plist__) */
