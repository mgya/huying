...
#ifndef __UMPStack__parray__
#define __UMPStack__parray__
...
public:
    ...
    PAbstractArray(
                   ...
                   PBOOL dynamicAllocation       ///< Buffer is copied and dynamically allocated.
    );
    //@}
...
protected:
    PBOOL InternalSetSize(PINDEX newSize, PBOOL force);
...
public:
    ...
    PBaseArray(
               ...
               PBOOL dynamic = TRUE ///< Buffer is copied and dynamically allocated.
...
cls(T const * buffer, PINDEX length, PBOOL dynamic = TRUE) \
...
public: \
    ...
    inline cls(P_##cls##_Base_Type const * buffer, PINDEX length, PBOOL dynamic = TRUE) \
    : PAbstractArray(sizeof(P_##cls##_Base_Type), buffer, length, dynamic) { } \
    virtual PObject * Clone() const \
    { return PNEW cls(*this, GetSize()); } \
    inline PBOOL SetAt(PINDEX index, P_##cls##_Base_Type val) \
    ...
    { PASSERTINDEX(index); return index < GetSize() ? \
        ...
        inline PBOOL Concatenate(cls const & array) \
        { return PAbstractArray::Concatenate(array); } \
        }
...
#define PDECLARE_ARRAY(cls, T) \
        ...
        public: \
            ...
            public:
                ...
                PBOOL SetAt(
                           PINDEX index,   ///< Position in the array to set the new value.
                           PBOOL val           ///< Value to set in the array.
                           );
...
#endif /* defined(__UMPStack__parray__) */
