...
#ifndef __UMPStack__pcypher__
#define __UMPStack__pcypher__
...
public:
    ...
    void StartEncoding(
                       PBOOL useCRLFs = TRUE  // Use CR, LF pairs in end of line characters.
    );
    ...
    /** Return a flag to indicate that the input was decoded without any
     ...
     Decoded data for the processed Base64 string.
     */
    PBOOL IsDecodeOK() { return perfectDecode; }
...
protected:
    ...
    virtual void Initialise(
                            PBOOL encoding   ///< Flag for encoding/decoding sequence about to start.
    ) = 0;
...
#endif /* defined(__UMPStack__pcypher__) */
