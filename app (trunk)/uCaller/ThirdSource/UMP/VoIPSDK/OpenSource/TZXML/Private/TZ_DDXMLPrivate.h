...
#define TZ_DDXMLAssert(condition, desc, ...)                                                                 \
  do{                                                                                                     \
    if(!(condition)) {                                                                                    \
...
#define TZ_DDXMLNotZombieAssert()                                                                            \
  do{                                                                                                     \
    if(TZ_DDXMLIsZombie(genericPtr, self)) {                                                                      \
...
#define DDLastErrorKey @"TZ_DDXML:LastError"



/**
 * TZ_DDXMLNode can represent several underlying types, such as xmlNodePtr, xmlDocPtr, xmlAttrPtr, xmlNsPtr, etc.
...
@interface TZ_DDXMLNamespaceNode : TZ_DDXMLNode
{
...
- (id)initWithNsPrimitive:(xmlNsPtr)ns nsParent:(xmlNodePtr)parent owner:(TZ_DDXMLNode *)owner;

- (xmlNodePtr)_nsParentPtr;
- (void)_setNsParentPtr:(xmlNodePtr)parentPtr;

// Overrides several methods in TZ_DDXMLNode
...
@interface TZ_DDXMLAttributeNode : TZ_DDXMLNode
{
...
- (id)initWithAttrPrimitive:(xmlAttrPtr)attr owner:(TZ_DDXMLNode *)owner;
...
@interface TZ_DDXMLInvalidNode : TZ_DDXMLNode
{
}
...
@interface TZ_DDXMLNode (PrivateAPI)
...
- (id)initWithPrimitive:(xmlKindPtr)kindPtr owner:(TZ_DDXMLNode *)owner;
...
@interface TZ_DDXMLElement (PrivateAPI)

+ (id)nodeWithElementPrimitive:(xmlNodePtr)node owner:(TZ_DDXMLNode *)owner;
- (id)initWithElementPrimitive:(xmlNodePtr)node owner:(TZ_DDXMLNode *)owner;
...
@interface TZ_DDXMLDocument (PrivateAPI)

+ (id)nodeWithDocPrimitive:(xmlDocPtr)doc owner:(TZ_DDXMLNode *)owner;
- (id)initWithDocPrimitive:(xmlDocPtr)doc owner:(TZ_DDXMLNode *)owner;
