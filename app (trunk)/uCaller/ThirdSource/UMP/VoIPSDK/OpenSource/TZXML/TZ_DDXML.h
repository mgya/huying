...
// to use the NSXML prefixes instead of the TZ_DDXML prefix.
// 
// This way, on Mac OS X it uses NSXML, and on iOS it uses KissXML.

#ifndef NSXMLNode
  #define NSXMLNode TZ_DDXMLNode
#endif
#ifndef NSXMLElement
  #define NSXMLElement TZ_DDXMLElement
#endif
#ifndef NSXMLDocument
  #define NSXMLDocument TZ_DDXMLDocument
#endif

#ifndef NSXMLInvalidKind
  #define NSXMLInvalidKind TZ_DDXMLInvalidKind
#endif
#ifndef NSXMLDocumentKind
  #define NSXMLDocumentKind TZ_DDXMLDocumentKind
#endif
#ifndef NSXMLElementKind
  #define NSXMLElementKind TZ_DDXMLElementKind
#endif
#ifndef NSXMLAttributeKind
  #define NSXMLAttributeKind TZ_DDXMLAttributeKind
#endif
#ifndef NSXMLNamespaceKind
  #define NSXMLNamespaceKind TZ_DDXMLNamespaceKind
#endif
#ifndef NSXMLProcessingInstructionKind
  #define NSXMLProcessingInstructionKind TZ_DDXMLProcessingInstructionKind
#endif
#ifndef NSXMLCommentKind
  #define NSXMLCommentKind TZ_DDXMLCommentKind
#endif
#ifndef NSXMLTextKind
  #define NSXMLTextKind TZ_DDXMLTextKind
#endif
#ifndef NSXMLDTDKind
  #define NSXMLDTDKind TZ_DDXMLDTDKind
#endif
#ifndef NSXMLEntityDeclarationKind
  #define NSXMLEntityDeclarationKind TZ_DDXMLEntityDeclarationKind
#endif
#ifndef NSXMLAttributeDeclarationKind
  #define NSXMLAttributeDeclarationKind TZ_DDXMLAttributeDeclarationKind
#endif
#ifndef NSXMLElementDeclarationKind
  #define NSXMLElementDeclarationKind TZ_DDXMLElementDeclarationKind
#endif
#ifndef NSXMLNotationDeclarationKind
  #define NSXMLNotationDeclarationKind TZ_DDXMLNotationDeclarationKind
#endif

#ifndef NSXMLNodeOptionsNone
  #define NSXMLNodeOptionsNone TZ_DDXMLNodeOptionsNone
#endif
#ifndef NSXMLNodeExpandEmptyElement
  #define NSXMLNodeExpandEmptyElement TZ_DDXMLNodeExpandEmptyElement
#endif
#ifndef NSXMLNodeCompactEmptyElement
  #define NSXMLNodeCompactEmptyElement TZ_DDXMLNodeCompactEmptyElement
#endif
#ifndef NSXMLNodePrettyPrint
  #define NSXMLNodePrettyPrint TZ_DDXMLNodePrettyPrint
#endif
...
// So a TZ_DDXMLNode, TZ_DDXMLElement, or TZ_DDXMLDocument are simply objective-c objects
...
// the library may create multiple TZ_DDXML wrapper objects that point to the same underlying xml node.
...
// </starbucks>
// 
// Imagine you have a TZ_DDXMLNode corresponding to the starbucks node,
// and you have a TZ_DDXMLNode corresponding to the latte node.
...
// So even though the TZ_DDXMLNode corresponding to the starbucks node may get deallocated,
...
// And what if you still have a reference to the TZ_DDXMLNode that corresponds to the latte node?
...
// 
// How does it work?
// Well everytime a TZ_DDXML wrapper object is created atop a libxml structure,
...
// So everytime a TZ_DDXML wrapper objects is about to dereference it's pointer,
...
#if DEBUG
  #define TZ_DDXML_DEBUG_MEMORY_ISSUES 0
#else
  #define TZ_DDXML_DEBUG_MEMORY_ISSUES 0 // Don't change me!
#endif
