//
//  SearchExtendContactContainer.m
//  uCaller
//
//  Created by 张新花花花 on 15/7/23.
...
@implementation SearchExtendContactContainer

- (void)reloadData
{
    
    contacts = [[ContactManager sharedInstance] searchContactsWithKey:strKeyWord];
...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    NSString *key = [NSString stringWithFormat: @"搜索到%d个联系人",contacts.count];
    if (contacts.count == 0) {
