...
- (void) show{
	...
	CGSize textSize = [text sizeWithFont:font constrainedToSize:CGSizeMake([[UIScreen mainScreen] bounds].size.width-40, 60)];
...
//    label.font = [UIFont systemFontOfSize:12];
	...
	v.frame = CGRectMake(0, 15, textSize.width + 10, textSize.height + 10);
	...
	if (theSettings.gravity == iToastGravityTop) {
		...
		point = CGPointMake(window.frame.size.width / 2, window.frame.size.height - 65);
