...
@property (assign, nonatomic) BOOL bNormalToRight;
@property (copy, readwrite, nonatomic) void (^didActionOfMenu)(NSInteger cellIndexNum, NSInteger menuIndexNum);//菜单处理block
