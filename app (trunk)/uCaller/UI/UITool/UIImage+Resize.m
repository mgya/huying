...
- (UIImage *)resizedImage:(CGSize)newSize
{
    ...
    CGFloat posX = (newSize.width - oldSize.width*scale)/2.0f;
    CGFloat posY = (newSize.height - oldSize.height*scale)/2.0f;
    
    UIGraphicsBeginImageContext(newSize);
    
    [self drawInRect:CGRectMake(posX,posY,oldSize.width*scale,oldSize.height*scale)];
